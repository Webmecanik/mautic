...
namespace MauticPlugin\MauticYellowboxCrmBundle\Tests\TestDataProvider;

use MauticPlugin\MauticYellowboxCrmBundle\Yellowbox\Model\Contact;

class YellowboxContactTestDataProvider
{
    private static $updatedYellowbox = [
        [
            'id'                  => '12x5799',
            'modifiedtime'        => '2018-11-09 12:40:14',
            'ID_GESTIONNAIRE'     => '19x1',
     ...
     * @return Contact[]
     */
    public static function getYellowboxContacts()
    {
        $contacts = [];
        foreach (self::$updatedYellowbox as $contactData) {
    ...
    public static function getUpdatedYellowbox()
    {
        return self::$updatedYellowbox;
    }
