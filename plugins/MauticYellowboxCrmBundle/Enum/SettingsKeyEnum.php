...
final class SettingsKeyEnum
{
     ...
     * @var string
     */
    public const OWNER_MAUTIC_UPDATE_IS_ENABLED = 'updateMauticOwner';

    /**
     * @var string
     */
    public const OWNER_MAUTIC_UPDATE_USER_ROLE = 'updateMauticOwnerUserRole';

    public const SYNC_ADDRESS_OBJECTS = 'sync_address_objects';
    public const SYNC_ADDRESS_TYPE    = 'sync_address_type';
